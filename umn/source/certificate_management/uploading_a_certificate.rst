...
#. In the **Upload Certificate** dialog box, enter a certificate name, and copy the certificate file and private key into the corresponding text boxes.
   ...
   .. figure:: /_static/images/en-us_image_0000001338097417.png
      :alt: **Figure 1** **Upload Certificate**

      **Figure 1** **Upload Certificate**

   Only .pem certificates can be used in WAF. If the certificate is not in .pem format, convert it into .pem locally by referring to :ref:`Table 1 <waf_01_0078__waf_01_0002_table1292125414516>` before uploading it.

   .. _waf_01_0078__waf_01_0002_table1292125414516:
