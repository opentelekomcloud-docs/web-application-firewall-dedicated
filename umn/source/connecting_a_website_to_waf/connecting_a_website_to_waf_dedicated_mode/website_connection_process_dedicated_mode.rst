...
.. table:: **Table 1** Domain name or IP address details required
   ...
   |                        |                  |                                                                                                                                                                                                                                             |                 |
   |                        |                  |       NOTICE:                                                                                                                                                                                                                               |                 |
   |                        |                  |       If your website uses a non-standard port, check whether the WAF edition you plan to buy can protect the non-standard port before you make a purchase. For details, see :ref:`Which Non-Standard Ports Can WAF Protect? <waf_01_1249>` |                 |
   +------------------------+------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------+
